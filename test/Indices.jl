...
@testset "VectorIndices" begin
    ...
    io = IOBuffer(); show(io, MIME"text/plain"(), inds); @test String(take!(io)) == "0-element Indices{Int64,Array{Int64,1}}"
    ...
    io = IOBuffer(); show(io, MIME"text/plain"(), inds); @test String(take!(io)) == "1-element Indices{Int64,Array{Int64,1}}\n 10"
